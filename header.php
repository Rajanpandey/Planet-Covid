<nav class="navbar sticky-top navbar-expand-sm bg-dark navbar-dark">
    <ul class="navbar-nav nav-pills">
        <li class="nav-item">
            <a class="nav-link <?php echo !strpos($_SERVER['REQUEST_URI'], 'map.php') && !strpos($_SERVER['REQUEST_URI'], 'pune.php') && !strpos($_SERVER['REQUEST_URI'], 'feedback.php') && !strpos($_SERVER['REQUEST_URI'], 'puneLockdown.php') && !strpos($_SERVER['REQUEST_URI'], 'protectYourself.php') ? 'active' : ''?>" href="index.php">   Home</a>
        </li>
        <li class="nav-item">
